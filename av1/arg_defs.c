...
const av1_codec_arg_definitions_t g_av1_codec_arg_defs = {
  ...
  .arnr_strength =
      ARG_DEF(NULL, "arnr-strength", 1, "AltRef filter strength (0..4), default is 2"),
  ...
  .enable_cdef = ARG_DEF(
      NULL, "enable-cdef", 1,
      "Enable the constrained directional enhancement filter (0: false (default), "
      "1: true, 2: disable for non-reference frames)"),
  ...
  .qm_min = ARG_DEF(NULL, "qm-min", 1,
                    "Min quant matrix flatness (0..15), default is 0"),
